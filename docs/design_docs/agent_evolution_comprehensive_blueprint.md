...
> **状态（2026-09-04）：未实施的全栈演进蓝图。** 文中 Phase 规划（Quality Guard / 多模态 / 多智能体编排）均未落地，将在后续阶段实施；阅读时请勿将文中架构当作现状。
> **基线说明**：文中 `docs/` 路径为文档拆分前的旧目录，现行文档在 `design_docs/` / `work_docs/` / `analysis_docs/`；原 `agent_architecture.md` 已删除，现行架构以 [project_overview.md](../analysis_docs/project_overview.md) 为准；"DeepSeek" 指代撰写时的对话模型，实际模型由 `.env LLM_MODEL` 声明。
>
> **报告版本**：v1.0
> **生成日期**：2026-08-24
...
> 1. [deep_agents_integration_design.md](./deep_agents_integration_design.md)（Quality Guard / Critic 设计，未实施规划）
> 3. [multimodal_evolution_design.md](./multimodal_evolution_design.md)（多模态演进，未实施规划）
>
...
- 项目已存在 [deep_agents_integration_design.md](./deep_agents_integration_design.md)（v2026-08-24 撰）
...
- 按 [deep_agents_integration_design.md](./deep_agents_integration_design.md) Phase A-D 实施 quality_guard
...
### 6.4 与 [deep_agents_integration_design.md](./deep_agents_integration_design.md) 的衔接
...
- ✅ 改造分阶段实施，任一阶段可独立旁路回滚
- ✅ 项目内已存在 [deep_agents_integration_design.md](./deep_agents_integration_design.md) 与 [multimodal_evolution_design.md](./multimodal_evolution_design.md) 两份规划，本文是它们的"全栈蓝图"扩展
...
| Quality Guard plan | [deep_agents_integration_design.md](./deep_agents_integration_design.md) | 全文件 | 嵌入式 Critic 设计 |
| 多模态 plan | [multimodal_evolution_design.md](./multimodal_evolution_design.md) | 全文件 | 多模态演进蓝图 |

### 附录 B：现有 reference 文档优先级阅读清单

如需深入实施细节，请按以下顺序阅读：

1. [../analysis_docs/project_overview.md](../analysis_docs/project_overview.md) — 现行架构总体参考（必读；原 agent_architecture.md 已删除）
2. [deep_agents_integration_design.md](./deep_agents_integration_design.md) — Quality Guard 详细设计（Phase 3 必读，未实施规划）
3. [three_core_modules_design_and_feasibility.md](./three_core_modules_design_and_feasibility.md) — 业务契约（任何阶段必读）
4. [multimodal_evolution_design.md](./multimodal_evolution_design.md) — 多模态演进（Phase 7 必读，未实施规划）
5. [data_architecture_upgrade_plan.md](./data_architecture_upgrade_plan.md) — 数据架构升级（任何阶段参考）
