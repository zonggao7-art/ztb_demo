...
| [pipeline_refactor_execution_plan.md](pipeline_refactor_execution_plan.md) | `public_kb` 在线检索、生成层、离线入库 Pipeline 的分阶段重构方案 | 当前执行基线 |
...
当前最新代码结构审查入口是 [../code_review_two_pipelines.md](../code_review_two_pipelines.md)；当前 POC 验证证据入口是 [../hybrid_poc_verification_report.md](../hybrid_poc_verification_report.md)。
