...
- **网页端**：[招投标智能助手在线演示](https://renounce-untaxed-algebra.ngrok-free.dev)
- **飞书端**：机器人「招投标智能助手」

两个入口均依赖作者本地运行环境，按需启动，暂不提供全天在线服务。**请提前联系作者预约，确认服务启动后再体验。** 服务关闭期间，网页可能无法访问，机器人可能无法回复。

无需预约即可查看本页的功能截图与真实工具调用记录。

## 项目演示

以下截图展示页面交互、查询结果及引用溯源。
