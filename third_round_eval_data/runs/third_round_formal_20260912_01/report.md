...
| 轮次 | 指标 | 结果 | 门槛 | 判定 |
|---:|---|---:|---:|---:|
| 1 | B1 | 0.9752 | ≥95.00% | True |
| 1 | B2 | 0.8820 | ≥85.00% | True |
| 1 | B3 | 0.8314 | ≥80.00% | True |
| 1 | B4 | 0.9712 | ≥95.00% | True |
...
| authorized_tool | knowledge_qa | 330 | B1 | 0.9786 | 330/330 |
| authorized_tool | knowledge_qa | 330 | B2 | 0.8907 | 330/330 |
| authorized_tool | knowledge_qa | 330 | B3 | 0.8316 | 330/330 |
| authorized_tool | knowledge_qa | 330 | B4 | 0.9674 | 330/330 |
...
| authorized_tool | query_company_award_history | 87 | B3 | 0.8135 | 24/24 |
...
| authorized_tool | query_company_penalty | 114 | B3 | 0.8943 | 24/24 |
| authorized_tool | query_company_penalty | 114 | B4 | 0.9177 | 24/24 |
...
| authorized_tool | query_project_award | 162 | B1 | 1.0000 | 24/24 |
| authorized_tool | query_project_award | 162 | B2 | 0.9097 | 24/24 |
| authorized_tool | query_project_award | 162 | B3 | 0.8652 | 24/24 |
| authorized_tool | query_project_award | 162 | B4 | 1.0000 | 24/24 |
...
| case_category | rag_anchor | 210 | B1 | 0.9664 | 210/210 |
| case_category | rag_anchor | 210 | B2 | 0.8808 | 210/210 |
| case_category | rag_anchor | 210 | B3 | 0.8159 | 210/210 |
| case_category | rag_anchor | 210 | B4 | 0.9685 | 210/210 |
...
| case_category | sql_rag_cross_capability | 120 | B1 | 1.0000 | 120/120 |
| case_category | sql_rag_cross_capability | 120 | B2 | 0.9080 | 120/120 |
| case_category | sql_rag_cross_capability | 120 | B3 | 0.8593 | 120/120 |
| case_category | sql_rag_cross_capability | 120 | B4 | 0.9654 | 120/120 |
...
| finish_status | complete | 676 | B1 | 0.9786 | 330/330 |
| finish_status | complete | 676 | B2 | 0.8907 | 330/330 |
| finish_status | complete | 676 | B3 | 0.8316 | 330/330 |
| finish_status | complete | 676 | B4 | 0.9674 | 330/330 |
...
| formal_run | repeat_1 | 280 | B1 | 0.9752 | 110/110 |
| formal_run | repeat_1 | 280 | B2 | 0.8820 | 110/110 |
| formal_run | repeat_1 | 280 | B3 | 0.8314 | 110/110 |
| formal_run | repeat_1 | 280 | B4 | 0.9712 | 110/110 |
...
| formal_run | repeat_2 | 280 | B3 | 0.8358 | 110/110 |
...
| normal_adversarial_or_fault | normal | 786 | B1 | 0.9786 | 330/330 |
| normal_adversarial_or_fault | normal | 786 | B2 | 0.8907 | 330/330 |
| normal_adversarial_or_fault | normal | 786 | B3 | 0.8316 | 330/330 |
| normal_adversarial_or_fault | normal | 786 | B4 | 0.9674 | 330/330 |
...
| normal_empty_or_failure | normal_result | 555 | B1 | 0.9782 | 324/324 |
| normal_empty_or_failure | normal_result | 555 | B2 | 0.8912 | 324/324 |
| normal_empty_or_failure | normal_result | 555 | B3 | 0.8311 | 324/324 |
| normal_empty_or_failure | normal_result | 555 | B4 | 0.9671 | 324/324 |
...
| rag_single_or_multi_hop | multi_hop | 165 | B1 | 0.9572 | 165/165 |
| rag_single_or_multi_hop | multi_hop | 165 | B2 | 0.8385 | 165/165 |
| rag_single_or_multi_hop | multi_hop | 165 | B3 | 0.8492 | 165/165 |
| rag_single_or_multi_hop | multi_hop | 165 | B4 | 0.9733 | 165/165 |
...
| rag_single_or_multi_hop | single_hop | 165 | B1 | 1.0000 | 165/165 |
| rag_single_or_multi_hop | single_hop | 165 | B2 | 0.9429 | 165/165 |
| rag_single_or_multi_hop | single_hop | 165 | B3 | 0.8141 | 165/165 |
| rag_single_or_multi_hop | single_hop | 165 | B4 | 0.9615 | 165/165 |
...
| single_or_multi_entity | not_applicable | 390 | B1 | 0.9664 | 210/210 |
| single_or_multi_entity | not_applicable | 390 | B2 | 0.8808 | 210/210 |
| single_or_multi_entity | not_applicable | 390 | B3 | 0.8159 | 210/210 |
| single_or_multi_entity | not_applicable | 390 | B4 | 0.9685 | 210/210 |
...
| single_or_multi_entity | single_entity | 288 | B1 | 1.0000 | 120/120 |
| single_or_multi_entity | single_entity | 288 | B2 | 0.9080 | 120/120 |
| single_or_multi_entity | single_entity | 288 | B3 | 0.8593 | 120/120 |
| single_or_multi_entity | single_entity | 288 | B4 | 0.9654 | 120/120 |
